...
export { isGitRepo, getRepoRoot, getRepoName, getCurrentBranch, getRepoInfo, getHeadHash, getDiffagentDir, getDiffagentDirPath, getRefCapabilities, isValidGitRef } from './repo.js';
